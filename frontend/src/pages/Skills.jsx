...
function Skills() {
  ...
  useEffect(() => {
    document.title = "Skills & Expertise | Nirja Pila, CA - Professional Accounting Skills";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Explore Nirja Pila\'s comprehensive skill set including IFRS, auditing, financial modeling, taxation, forensic accounting, and advanced technology skills in accounting software and analytics.');
    } else {
      const newMetaDescription = document.createElement('meta');
      newMetaDescription.name = 'description';
      newMetaDescription.content = 'Explore Nirja Pila\'s comprehensive skill set including IFRS, auditing, financial modeling, taxation, forensic accounting, and advanced technology skills in accounting software and analytics.';
