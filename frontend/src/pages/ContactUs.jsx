...
function ContactUs() {
  ...
  useEffect(() => {
    document.title = "Contact Nirja Pila | Chartered Accountant";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Contact Nirja Pila, CA for professional accounting services, auditing, taxation, and financial consulting. Get in touch for expert financial guidance and business advisory services.');
    } else {
      const newMetaDescription = document.createElement('meta');
      newMetaDescription.name = 'description';
      newMetaDescription.content = 'Contact Nirja Pila, CA for professional accounting services, auditing, taxation, and financial consulting. Get in touch for expert financial guidance and business advisory services.';
  ...
  const contactInfo = [
    ...
    },
    {
      icon: FaEnvelope,
      title: "Email",
      content: "nirja.pila.ca@email.com",
      link: "mailto:nirja.pila.ca@email.com"
    },
    {
      icon: FaPhone,
      title: "Phone",
