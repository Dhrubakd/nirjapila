...
function Services() {
  ...
  useEffect(() => {
    if (selectedService && showDetailView) {
      document.title = `${selectedService.title} | Nirja Pila CA Services`;
      
      const metaDescription = document.querySelector('meta[name="description"]');
      if (metaDescription) {
        metaDescription.setAttribute('content', `${selectedService.description.slice(0, 150)}... - Nirja Pila CA Services`);
      }
    } else {
      document.title = "My Services | Nirja Pila CA - Accounting & Financial Consulting";
