...
function Home() {
  ...
  useEffect(() => {
    document.title = "Nirja Pila, CA - Professional Chartered Accountant & Financial Consultant";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Nirja Pila - Expert Chartered Accountant with 8+ years experience in IFRS, auditing, taxation, financial modeling, and forensic accounting. Available for consulting across Nepal and India.');
    } else {
      const newMetaDescription = document.createElement('meta');
      newMetaDescription.name = 'description';
      newMetaDescription.content = 'Nirja Pila - Expert Chartered Accountant with 8+ years experience in IFRS, auditing, taxation, financial modeling, and forensic accounting. Available for consulting across Nepal and India.';
      document.getElementsByTagName('head')[0].appendChild(newMetaDescription);
    }

    // Cleanup function to reset title when component unmounts
    return () => {
      document.title = "Nirja Pila, CA";
    };
  }, []);
                    ...
                    <div className="space-y-4 mb-6">
                      <div className="flex items-center justify-center space-x-4 bg-white dark:bg-gray-800 rounded-xl p-5 shadow-lg hover:shadow-xl transition-shadow duration-300">
                        ...
                        <div className="text-left">
                          ...
                          <div className="text-sm text-gray-600 dark:text-gray-300 font-medium">nirja.pila.ca@email.com</div>
                        </div>
                      </div>
