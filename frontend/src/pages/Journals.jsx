...
function Journals() {
  ...
  useEffect(() => {
    document.title = "Journals | Nirja Pila CA - Professional Insights & Research";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Explore professional journals featuring accounting insights, financial research, audit case studies, and thought leadership articles on IFRS, taxation, and business advisory from Nirja Pila, CA.');
    } else {
      const newMetaDescription = document.createElement('meta');
      newMetaDescription.name = 'description';
      newMetaDescription.content = 'Explore professional journals featuring accounting insights, financial research, audit case studies, and thought leadership articles on IFRS, taxation, and business advisory from Nirja Pila, CA.';
