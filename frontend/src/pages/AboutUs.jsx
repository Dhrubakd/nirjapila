...
function AboutUs() {
  ...
  useEffect(() => {
    document.title = "About Nirja Pila | Chartered Accountant Portfolio";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Learn about Nirja Pila, a dedicated Chartered Accountant with expertise in auditing, taxation, IFRS, and financial consulting. Discover my professional background and commitment to excellence.');
    } else {
      const newMetaDescription = document.createElement('meta');
      newMetaDescription.name = 'description';
      newMetaDescription.content = 'Learn about Nirja Pila, a dedicated Chartered Accountant with expertise in auditing, taxation, IFRS, and financial consulting. Discover my professional background and commitment to excellence.';
  ...
  const team = [
    {
      ...
      image: "/uploads/profiles/nirja.png",
