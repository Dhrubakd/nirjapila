    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Company Info */}
          <div>
            <h3 className="text-white text-xl font-bold mb-4">Nirja Pila, CA</h3>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-gray-400">
                ...
                <span className="text-sm">nirja@nirjapila.com</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-400">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-1 text-gray-400 text-sm mb-4 md:mb-0">
            <span>&copy; {new Date().getFullYear()} Nirja Pila, CA. Made with</span>
