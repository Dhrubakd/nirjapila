          ...
          >
            ...
            <div className="mb-8">
              <ReactTyped
                ...
                strings={[
                  "Hello, I'm <span style='color: #4F46E5;'>Nirja Pila, CA</span>",
                ]}
                loop={true}
                backSpeed={50}
                typeSpeed={80}
            ...
            >
              <div className="flex items-center space-x-3 text-gray-600 dark:text-gray-300">
                ...
                <span className="text-base font-medium">nirja.pila.ca@email.com</span>
              </div>
          ...
          >
            <div className="relative">
              ...
              <div className="w-full h-96 lg:h-[550px] bg-gradient-to-br from-primary-100 to-secondary-100 rounded-2xl shadow-2xl overflow-hidden">
                <img 
                  src="/uploads/profiles/nirja.png" 
                  alt="Nirja Pila, Chartered Accountant"
